...
import { Send, Mail, MapPin, Linkedin, Instagram, Twitter } from 'lucide-react';
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:hello@chidinma.com" className="text-muted-foreground hover:text-primary transition-colors">
                    hello@chidinma.com
                  </a>
                </div>
              </div>
