...
const HeroSection = () => {
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-cream">
      ...
      <div className="absolute top-20 right-10 w-72 h-72 bg-sage-light rounded-full blur-3xl opacity-60 animate-float" />
      <div className="absolute bottom-20 left-10 w-96 h-96 bg-gold-light rounded-full blur-3xl opacity-40" style={{ animationDelay: '2s' }} />
        ...
        <div className="grid lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          <div className="order-1 lg:order-2 flex justify-center animate-fade-up stagger-2">
            <div className="relative">
              ...
              {/* Floating badge */}
              <div className="absolute -bottom-2 -right-2 bg-card px-4 py-2 rounded-full shadow-lg border border-border animate-float">
