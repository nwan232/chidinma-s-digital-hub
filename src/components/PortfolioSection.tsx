  ...
  const portfolioItems = [
    {
      ...
      Icon: Linkedin,
      href: '/Social Media Portfolio.pdf',
    ...
    },
    {
      ...
      category: 'Design',
      description: 'Strategic approach to creative content, brand positioning, and visual storytelling across all platforms.',
      Icon: Palette,
      href: '/public/Content calendar for the month of september (1).pdf',
      cta: 'Download Designs',
    ...
    },
    {
      ...
      Icon: FileText,
      href: '/public/ICLEAN CAMPAIGN NARRATIVE REPORT-portfolio.docx',
